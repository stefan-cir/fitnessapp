...
- **SC-005**: [UX consistency metric, e.g., "At least 95% of audited screens conform to shared UX patterns"]
- **SC-006**: [Performance metric, e.g., "p95 response time for primary flow stays under defined budget on target devices"]
